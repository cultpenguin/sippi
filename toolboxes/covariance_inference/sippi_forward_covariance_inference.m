...
%
% See Hansen et al. (201X), A general probabilistic approach for inference of Gaussian model parameters from noisy data of point and volume support. Submitted to Mathematical Geosciences, 2014.
%
